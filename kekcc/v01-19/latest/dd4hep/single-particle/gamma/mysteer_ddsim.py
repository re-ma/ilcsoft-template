...
from SystemOfUnits import mm, GeV, MeV, rad, mrad
...
infileEnv = "/cvmfs/ilc.desy.de/sw/x86_64_gcc49_sl6/v01-19-04/lcgeo/v00-13-04/ILD/compact/ILD_l1_v01/ILD_l1_v01.xml"
gunParticle = "gamma"
numberOfEvents = 10
gunEnergy = 10*GeV
outfileName = gunParticle + "_" + str(int(gunEnergy/GeV)) + "GeV.slcio"
gunDirection = "(1, 0, 0)"
#gunDistribution = "uniform"
gunDistribution = "cos(theta)"
#gunDistribution = None
gunphiMin = None
gunphiMax = None
gunthitaMin = 1*mrad
gunthitaMax = None
...
SIM.gun.direction = gunDirection
...
##SIM.gun.phiMax = None
SIM.gun.phiMax = gunphiMax

## Minimal azimuthal angle for random distribution
##SIM.gun.phiMin = None
SIM.gun.phiMin = gunphiMin
